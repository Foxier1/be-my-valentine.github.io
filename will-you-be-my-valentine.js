let messages = ["Пожалуйста?", "Дай мне шанс!", "Ты уверена??", "Подумай ещё раз!", "Ты можешь пожалеть об этом!", "Последний шанс!", "Ну пожаалуйста", "Не разбивай мне сердце💔"];
let noCount = 0;
...
function acceptLove() {
    document.getElementById("valentine").innerHTML = `
        ...
        <div class="question">ДАДАДАДАДАДА ОБОЖАЮ ТЕБЯ СОЛНЫШКО❤️</div>
    `;
    launchConfetti();
    startHeartRain();
}
